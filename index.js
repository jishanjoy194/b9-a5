let seat_array = [];
let coupon_code = ['NEW15','Couple 20'];
...
function seat_selected(id_value){
    ...
    if (i===0) {
        const firstTicketPosition = document.getElementById('first-ticket-position');
        firstTicketPosition.innerText = seat_array[0];
        ...
        const secondTicketPosition = document.getElementById('second-ticket-position');
        secondTicketPosition.innerText = seat_array[1];
        const secondTicket = document.getElementById('second-ticket');
        secondTicket.classList.add('flex');
        secondTicket.classList.remove('hidden');
    }
    else if(i===2){
        const thirdTicketPosition = document.getElementById('third-ticket-position');
        thirdTicketPosition.innerText = seat_array[2];
        ...
        const fourthTicketPosition = document.getElementById('fourth-ticket-position');
        fourthTicketPosition.innerText = seat_array[3];
...
function coupon(){
    let coupon = document.getElementById('input-disable');
    let couponCheck = coupon.value;
    let label_coupon = document.getElementById('label-id');
    label_coupon.classList.add('hidden');
